 ...
 * Purpose: LPC43xx clock initialisation
 * Version: V4.73
 * Note(s):
 *----------------------------------------------------------------------------
 ...
 * |  36MHz | 288MHz |  1  |  3  |  4  |   0    |   1   |    0   |
 * |  72MHz | 288MHz |  1  |  6  |  2  |   0    |   1   |    0   |
 * |  96MHz | 192MHz |  1  |  8  |  1  |   0    |   1   |    0   |
 * | 144MHz | 288MHz |  1  |  12 |  1  |   0    |   1   |    0   |
 ...
 * @param[in]  Hz	: Current frequency in Hz of the CPU
 * @return     None
 ...
 * decreased.
 **********************************************************************/
void SetFlashAcceleration(uint32_t Hz)
{
...
void SystemInit (void) {
  ...
  /* Set vector table pointer bits[28:7] */
  SCB->VTOR = ((uint32_t)(&__Vectors)) & 0x1FFFFF80UL;
  ...
  /* Configures the onboard Flash Accelerator */
  SetFlashAcceleration(SystemCoreClock);
}

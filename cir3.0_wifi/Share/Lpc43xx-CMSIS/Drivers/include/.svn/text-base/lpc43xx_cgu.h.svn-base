...
typedef enum {
	...
	OUTCLK_21_CTRL,								/**< Reserved output stages	*/
	OUTCLK_22_CTRL,								/**< Reserved output stages	*/
	OUTCLK_23_CTRL,								/**< Reserved output stages	*/
	OUTCLK_24_CTRL,								/**< Reserved output stages	*/
	CGU_BASE_APLL,								/**< Audio PLL Base clock		*/
	CGU_BASE_OUT0,								/**< Base clock for CGU_OUT0 clock output		*/
	CGU_BASE_OUT1,								/**< Base clock for CGU_OUT1 clock output		*/

...
#define MY_CPU_CLK         180000000
#define WAIT_CNT(ck,us)    ((ck/18000000)*us)
#define CHECK_TIMEOUT      250     // 500us

/********************************************************************//**
 * @brief		  Delay some microsecond on the basis of Core Clock

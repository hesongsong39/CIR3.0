...
#define CMD_FAST_READ               0x0C		/**< Read Data bytes at Fast Speed */
#define CMD_QOR                     0x6C		/**< Quad Output Read */
#define CMD_RDID                    0x9F		/**< Read Identification */
#define CMD_WREN                    0x06		/**< Write Enable */
#define CMD_P4E                     0x21		/**< 4 KB Parameter Sector Erase */
#define CMD_BULK_ERASE              0xC7		/**< Bulk Erase */
#define CMD_SECT_ERASE              0xDC		/**< 64KB Sector Erase */
#define CMD_PAGE_PROGRAM            0x12		/**< Page Programming */
#define CMD_QUAD_PAGE_PROGRAM       0x3E		/**< Quad Page Programming */
...
static void prvWaitUnBusy(LPC_SPIFI_CHIPHW_T *pSpifiCtrlAddr)
{
	...
	while ((prvGetStatusRegister(pSpifiCtrlAddr) & (STATUS_WIP | STATUS_WEL)) != 0) {}
}
...
static void prvSetQuadMode(LPC_SPIFI_CHIPHW_T *pSpifiCtrlAddr, uint8_t enQuadMode)
{
	...
	status = prvGetStatusRegister(pSpifiCtrlAddr);
	...
	/* write status / config */
	prvSetStatusRegister(pSpifiCtrlAddr, status);
}
...
SPIFI_DEV_FAMILY_T *SPIFI_REG_FAMILY_Macronix_2Byte_Status(void)
{
	...
	desc.pFamName = "Macronix MX66L51235F based family";
	...
	/* Add support for MX66L51235F */
	{
		...
		static const SPIFI_DEV_PDATA_T pData = {
			...
			(SPIFI_CAP_NOBLOCK | SPIFI_CAP_SUBBLKERASE|SPIFI_CAP_QUAD)	/* capabilities */
		};

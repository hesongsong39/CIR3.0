...
;********************************************************************************************************
    ...
    EXPORT  OSCtxSw
    EXPORT  OSIntCtxSw
    EXPORT  M0_OS_CPU_PendSVHandler
...
M0_OS_CPU_PendSVHandler
    CPSID   I                                                   ; Prevent interruption during context switch
    MRS     R0, PSP                                             ; PSP is process stack pointer

    CMP     R0, #0
    BEQ     M0_OS_CPU_PendSVHandler_nosave						; equivalent code to CBZ from M3 arch to M0 arch
...
M0_OS_CPU_PendSVHandler_nosave

...
void  M0_RIT_OR_WWDT_IRQHandler (void)
{
    ...
    LPC_RITIMER->CTRL |= 1;                      /* Clear Interrupt flag                               */
...
void  OS_CPU_SysTickInit (INT32U  cnts)
{
    ...
    LPC_RITIMER->COMPVAL = cnts - 1;           // Set match value
    ...
    // Configured as the highest priority interrupt
		NVIC_SetPriority(M0_RITIMER_OR_WWDT_IRQn, ((0x00 << 3) | 0x00));
